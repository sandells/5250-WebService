    ...
    public class ItemsController
    {
        ...
        public async Task<List<Item>> GetItemsFromGame(int number, int level, AttributeEnum attribute, ItemLocationEnum location, bool random, bool updateDataBase)
        {
            ...
            var dict = new Dictionary<string, string>
            {
                ...
                {"Location", ((int)location).ToString() }, //location
                {"Random", random.ToString() },  //random
            };
        ...
        private Item ConvertFromJson(JObject json)
        {
            ...
            try
            {
                ...
                //convert string fields: name, description, image url
                ...
                //convert int fields: range, value, damage
                ...
                //convert enum fields: location, attribute
